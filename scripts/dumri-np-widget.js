...
<table>
  ...
  <table>
    ...
    <tr>
      ...
      <a href='${sites[previousIndex]}'><img src="https://dumbiee.neocities.org/img/webring/neopets/prev.png" alt="prev site" style="padding:0.365vw; max-width:3vw;" width="34px"></a>
        ${randomText}
        ${indexText}
      <a href='${sites[nextIndex]}'><img src="https://dumbiee.neocities.org/img/webring/neopets/next.png" alt="next site" style="padding:0.365vw; max-width:3vw;" width="36px"></a></span></td>
    </tr>
  </table>
  `);
